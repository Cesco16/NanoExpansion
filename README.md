...
<img src="example_output/gmm_dual_methylation.png" alt="Descrizione dell'immagine" width="100" />
- `EPIGENETIC_WATERFALL_<sample>_<gene>.png` — per-allele methylation waterfall plot (if the BAM contains base-modification tags).
<img src="example_output/EPIGENETIC_WATERFALL_13204_DMPK.png" alt="Descrizione dell'immagine" width="100" />
- `EPIGENETIC_JOINT_MAP_<sample>_<gene>.png` — per-allele methylation waterfall plot (if the BAM contains base-modification tags).
<img src="example_output/EPIGENETIC_JOINT_MAP_13204_DMPK.png" alt="Descrizione dell'immagine" width="100" />
